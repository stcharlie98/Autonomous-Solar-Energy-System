...
// Here, the ESP32 initializes the serial communication, 
...
void loop()
{
  ...
  if (millis() - timer >= PUBLISH_FREQUENCY) 
  {
    ...
    // To find out via the Serial Monitor if
    ...
    delay(100);  
        ...
        // Checks Wi-Fi signal connection before entering sleep mode
